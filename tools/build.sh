...
GAME="src/game.c src/play.c src/air.c src/space.c src/boss.c src/ending.c"
...
if [ "$what" = all ] || [ "$what" = native ] || [ "$what" = check ]; then
    ...
    $CC -o tmp/ending_check.exe tests/ending_check.c src/png.c $CORE $GAME
